...
def loginFacebook(driver, email=None, password=None):
    ...
    element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.ID, "ssrb_composer_start")))

def loginLinkedIn(driver, email=None, password=None):
    if not email or not password:
        email, password = __prompt_email_password()
